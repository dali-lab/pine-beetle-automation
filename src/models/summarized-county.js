...
const SummarizedCountySchema = new Schema({
...
// compound index of year -> state -> county -> endobrev
SummarizedCountySchema.index({
  year: 1,
  state: 1,
  county: 1,
  endobrev: 1,
...
const SummarizedCountyModel = mongoose.model('SummarizedCounty', SummarizedCountySchema);

export default SummarizedCountyModel;
