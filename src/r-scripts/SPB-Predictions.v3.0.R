...
# coefficients for binomial model - new coefficients for 2025; predicts pi
b0_binom = .98518      # intercept
b1_binom = -1.20068    # SPB this year
b3_binom = -.69458   # spots last year
b4_binom = -.29778 # spots two years ago - new variable (added back) for 2025

# coefficients for count  - new coefficients for 2025; predicts mu
b0_count = 0.70402     # intercept
b1_count = 0.25500    # SPB this year
b3_count = 0.17556     # spots last year

# means and SDs of the log-transformed data used to fit the model - new values for 2025,based on training data.
# Used for centering and standardized the log transformed input data
SPB_mean = 3.100574
SPB_SD = 3.033657
spotst1_mean = 1.030685
spotst1_SD = 1.897232
spotst2_mean = 1.166224 # new for 2025 (variable added back)
spotst2_SD =  2.008037 # new for 2025 (variable added back)
...
lnspotst2=log(spotst2+1) # new for 2025 (variable added back)

# center and standardize log transformed values
SPB_adj=(lnSPB-SPB_mean)/SPB_SD                           
spotst1_adj=(lnspotst1-spotst1_mean)/spotst1_SD
spotst2_adj=(lnspotst2-spotst2_mean)/spotst2_SD # new for 2025 (variable added back)

# Calculate mu and pi
pi_pre = b0_binom+b1_binom*SPB_adj+b3_binom*spotst1_adj+b4_binom*spotst2_adj # added back spotst2 for 2025
