# Predictions-for-SPBpredict.com_v4.0.R
...
# revised by Matt on 18 March 2025 to match new ZIP model based on n = 3282 observations. 
...
b0_binom = 1.04262      # intercept
b1_binom = -1.19036    # SPB this year
b2_binom = -0.88167   # spots last year
b3_binom =-0.24834

# coefficients for count model; predicts mu
b0_count = 0.63727     # intercept
b1_count = 0.31206    # SPB this year
b2_count = 0.21882     # spots last year
...
adjusted_SPB=SPB
adjusted_SPB[endobrev==0] = adjusted_SPB[endobrev==0]*10 # mulitply SPB by 10 if no endobrevicomin
...
spotst2_adj=(lnspotst2-spotst1_mean)/spotst2_SD

# Calculate mu and pi
pi_pre = b0_binom+b1_binom*SPB_adj+b2_binom*spotst1_adj+b3_binom*spotst2_adj
mu_pre = b0_count+b1_count*SPB_adj+b2_count*spotst1_adj
